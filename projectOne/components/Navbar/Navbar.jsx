    ...
    <div className="border-b border-light-gray">
      <div className="container mx-auto px-4 flex items-center justify-between py-4">
        ...
        <div className="hidden md:flex items-center space-x-4 ">
          <Link href="/login">
            <button className="px-4 py-2 text-gray text-sm md:text-base xl:text-[16px]">
              Log In
            </button>
          </Link>
          <Link href="/signup">
            <button className="px-4 py-3  text-white rounded-[5px] bg-blue text-sm md:text-base xl:text-[16px]">
              Sign Up
            </button>
          </Link>
        </div>
        ...
        <div className="container md:hidden bg-white mx-auto text-gray">
          <ul className="flex flex-col text-center space-y-4 text-gray-700 px-4 py-6">
            ...
            <div className="flex flex-col space-y-4 mt-4">
              <Link href="/login">
                <button className="px-4 py-2 border border-gray-300 text-gray-700 rounded w-[100%]">
                  Log In
                </button>
              </Link>
              <Link href="/signup">
                <button className="px-4 py-2 text-white rounded bg-blue w-[100%]">
                  Sign Up
                </button>
              </Link>
            </div>
